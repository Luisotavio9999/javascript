...
//o metodo forEach - significa para cada item de vetor
//dentro do parentases colocamos a variavel que ira
//rceber o conteudo de cada linha do vetor
//e com 0 => {} informamos o clocos que ira executar para 
//cada linha
frutas.forEach( item => { 
    console.log ('item pelo forEach', item)
 } )
//quando precisamos do indice tambem e colocarmos entre {}
//assim como no exemplo abaixo
frutas.forEach( (item, pos) => { 
    console.log ('item pelo forEach', pos ,item)
 } )
